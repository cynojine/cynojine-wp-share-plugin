...
Plugin URI: https://app.cynojinr.com
...
function social_share_settings()
{
    ...
    add_settings_field("social-share-cynojine", "Do you want to display cynojine share button?", "social_share_cynojine_checkbox", "social-share", "social_share_config_section");
    ...
    register_setting("social_share_config_section", "social-share-cynojine");
}
...
function social_share_cynojine_checkbox()
{  
   ?>
        <input type="checkbox" name="social-share-cynojine" value="1" <?php checked(1, get_option('social-share-cynojine'), true); ?> /> Check for Yes
   <?php
}
